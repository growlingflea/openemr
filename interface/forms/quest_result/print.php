...
<html>
	<head>
		...
		<title>Quest Lab Results for <?php echo $result_data->request_pat_last; ?>", " <?php echo $result_data->request_pat_first; ?><?php echo ($result_data->request_pat_middle)?" ".$result_data->request_pat_middle:''; ?> on <?php echo $result_data->result_datetime; ?></title>

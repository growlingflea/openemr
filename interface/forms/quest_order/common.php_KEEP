...
$query .= "WHERE l.list_id LIKE 'Quest_Diagnosis%' ";
...
<?php 
$title = 'Search';
echo "<div class='wmtQuick' id='dc_Search' style='display:none'><table width='100%'><tr><td style='text-align:center;padding-top:30px'><h3>Select panel at left or<br/>search using search box at top.</h3></tr></td>\n";
foreach ($dlist as $data) {
	if ($data['title'] != $title) {
...
?>
						<tr>
							<td>
								<fieldset>
									<legend>Order Requesition - <?php echo $ordnum ?></legend>
...
<?php 
// load the existing requestion codes
$newRow = '';
...
<?php } ?>
									...
									<table style="width:100%;margin-top:15px">
										<tr>
											<td>
												<label class="wmtLabel">Lab Notes / Comments:  <small style='font-weight:normal;padding-left:20px'>[ Sent to lab but not printed on requesition ]</small></label>
								...
								<table style="width:100%">
									<tr>
										<td class="wmtLabel" colspan="3">
											Clinic Notes:  <small style='font-weight:normal;padding-left:20px'>[ Not sent to lab or printed on requesition ]</small>

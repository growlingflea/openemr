...
$result_data->reviewed_id = $_POST['reviewed_id'];
$result_data->notified_id = $_POST['notified_id'];
$result_data->notified_person = $_POST['notified_person'];
$result_data->result_notes = $_POST['result_notes'];
$result_data->result_handling = $_POST['result_handling'];

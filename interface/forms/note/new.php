...
$note2 = "{$patient_data['fname']}  has two or more low risk symptoms, or one or more high risk symptoms. {$patient_data['fname']}'s COVID-19 test was negative, so may return to school when symptoms are improving and when there is no fever for 24 hours.";
...
<span class="title"><?php echo xlt('Work/School Note'); ?></span><br /><br />
    ...
    <select name="note_type" id="note_type">
        ...
        <option value="COVID-19 SCHOOL NOTE" <?php if ($obj['note_type']=="COVID-19 SCHOOL NOTE") echo " SELECTED"; ?>><?php xl('COVID-19 SCHOOL NOTE','e'); ?></option>
        ...
        <option value="REFERRAL" <?php if ($obj['note_type']=="REFERRAL") echo " SELECTED"; ?>><?php xl('REFERRAL','e'); ?></option>
        <!--   //*** oe-ca-pediatric-printout-menu ADD-->
